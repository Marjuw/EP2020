...
//    var seifenkiste: One_Project = One_Project(projektleiter = specificUserID, name = "Seifenkisten bauen Teil 2!", gewuenschteTeamgroesse = 3,
...
//        kategorie = listOf(1,2,3), ausfuehrungsort = "Köln", zweck = listOf(1, 3), teilnehmer = listOf(specificUserID) )
//    val jsonProjectObject = gson.toJson(seifenkiste) // das One_Project Objekt wird in einen JSON String geparset
//    okHttpPost(ressource_projects, jsonProjectObject) // das Projekt wird gepostet
...
data class One_Project(val _id: String? = null,
                       @SerializedName ("projektleiter") val projektleiter: String,
